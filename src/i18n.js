    ...
    .init({
        ...
        resources: {
            ...
            ru: {
                about: {
                    title: 'Обо мне',
                    intro: 'Всем привет! С вами DoubleCookies — тот, кто любит создавать программы по мелочи, кушать печенье, изучать статистику и многое другое. ' +
                        'Более подробно о различных направлениях моей деятельности можно будет прочитать ниже.'
                },
                programming: {
